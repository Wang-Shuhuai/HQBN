...
class BasicBlock_1w1a(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.sc_bn1 = nn.BatchNorm2d(planes)
        self.sc_bn2 = nn.BatchNorm2d(planes)
        self.sc_bn3 = nn.BatchNorm2d(in_planes)
        ...
        self.x_bn1 = nn.BatchNorm2d(planes)
        self.x_bn2 = nn.BatchNorm2d(planes)

        self.channel_scales_1 = nn.Parameter(torch.rand(planes, 1, 1), requires_grad=True)
        self.channel_scales_2 = nn.Parameter(torch.rand(planes, 1, 1), requires_grad=True)
